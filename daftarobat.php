    ...
    <div class="badan">
      ...
      <form>
          ...
          <div class="search">
            ...
            <button class="resetbtn" onclick="location.href='daftarobat.php'" type="button">Reset</button>
              </div>
      </form>
                 <hr>
      <div class="content">
            ...
            <tr align="center">
              <td>
                ...
                <td>
                 ...
                 <td>
                  <img src="obat/gambar/<?php echo $row['file'];?>" widht="100px" height="100px" >
                 </td>
                <td>
                  <a href="transaksi/order.php?id=<?php echo $row['id'];?>">Beli</a>
                </td>
            </tr>
                <?php
                 }
      ...
      <?php
          ...
          if($kolomCari=="" && $kolomKataKunci==""){
          ?>
            <a class="prv" href="daftarobat.php?page=<?php echo $LinkPrev; ?>">Previous</a></li>
       <?php
          }else{
        ?>
          <a class="prv" href="daftarobat.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a>
         <?php
           }
        }
      ?>
      ...
      <?php
        ...
        for($i = $startNumber; $i <= $endNumber; $i++){
          ...
          if($kolomCari=="" && $kolomKataKunci==""){
      ?>
          <a class="number" href="daftarobat.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>

      <?php
        }else{
          ?>
          <a class="number" href="daftarobat.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
          <?php
        }
      }
      ?>
      ...
      <?php
       ...
       if($kolomCari=="" && $kolomKataKunci==""){
          ?>
            <a class="nxt" href="daftarobat.php?page=<?php echo $linkNext; ?>">Next</a>
       <?php
          }else{
        ?>
          <a class="nxt" href="daftarobat.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a>
      <?php
        }
      }
      ?>
