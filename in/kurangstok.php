...
<html>
<head>
    <title>Pengurangan Jumlah Stok Alat Medis Masuk</title>
     <link rel="stylesheet" type="text/css" href="../asset/jumlahstok.css">
</head>
<body style="background-image: url(../BG.png)">
    <div class="jmlstok">
            <h2>
                Pengurangan Jumlah Stok Alat Medis Masuk
            </h2>
            <div>
...
<?php
    ...
    $hasil=$jmlh-$kurang;
        ...
        ?>
        <script language="JavaScript">
            alert('Oops! Jumlah pengurangan lebih besar dari stok ...');
            document.location='../alatmasukadmin.php';
        </script>
        <?php
    }
           ...
           if($ambil){
                    ...
                    ?>
                    <script language="JavaScript">
                        alert('Good! Pengurangan Jumlah Stok Alat Medis Masuk berhasil ...');
                        document.location='../alatmasukadmin.php';
                    </script>
                    <?php
                }
